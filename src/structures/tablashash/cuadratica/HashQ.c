...
HashQTable initHashTable(unsigned int tamInicial, fn_folding f_folding, fn_comparar f_cmp,fn_imprimir f_imp){
	HashQTable hashtable;

    hashtable.table = calloc(tamInicial, sizeof(void*));
    hashtable.len = tamInicial;
    hashtable.cant = 0;
    
    hashtable.min = 30;
    hashtable.max = 60;
    hashtable.fixed = 45; //(30+60)/2
    
    hashtable.folding = f_folding;
    hashtable.comparar = f_cmp;
    hashtable.imprimir = f_imp;
    hashtable.verbose = 0;
    return hashtable;
}
